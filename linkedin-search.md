...
Here are some examples, but you can find the endpoint documentation with all parameters details here: Get Linkedin Search Parameters API & Perform a Linkedin Search API

Please have a look on Linkedin limitations about this endpoint.
